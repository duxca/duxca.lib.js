...
module duxca.lib {
  ...
  export class Chord2{
    ...
    _connectionHandler(conn: PeerJs.DataConnection){
      ...
      var ondata: (data:{msg:string, id:string, successors:string[], token:Chord2.Token})=>void = null;
        ...
        switch(data.msg){
          ...
          case "Token":
            ...
            if(this.successor.open){
              ...
              this.ontoken(data.token, (token: Chord2.Token)=>{

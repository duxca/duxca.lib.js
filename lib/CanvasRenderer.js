...
var CanvasRenderer = (function () {
    ...
    CanvasRenderer.prototype.drawSignal = function (signal, flagX, flagY) {
    ...
    CanvasRenderer.prototype.drawColLine = function (x) {
        this.ctx.beginPath();
        this.ctx.moveTo(x, 0);
        this.ctx.lineTo(x, this.cnv.height);
        this.ctx.stroke();
    };
    CanvasRenderer.prototype.drawRowLine = function (y) {
        this.ctx.beginPath();
        this.ctx.moveTo(0, y);
        this.ctx.lineTo(this.cnv.width, y);
        this.ctx.stroke();
    };
    CanvasRenderer.prototype.cross = function (x, y, size) {
        this.ctx.beginPath();
    ...
    CanvasRenderer.prototype.arc = function (x, y, size) {
        this.ctx.beginPath();
        this.ctx.arc(x, y, size, 0, 2 * Math.PI, false);
        this.ctx.stroke();
    };
    CanvasRenderer.prototype.drawSpectrogram = function (spectrogram, max) {
        ...
        for (var i = 0; i < spectrogram.length; i++) {
            for (var j = 0; j < spectrogram[i].length; j++) {
                var _a = CanvasRenderer.hslToRgb(spectrogram[i][j] / max, 0.5, 0.5), r = _a[0], g = _a[1], b = _a[2];
    ...
    CanvasRenderer.prototype._drawSpectrogram = function (rawdata, sampleRate) {
...
(function (CanvasRenderer) {
    ...
    CanvasRenderer.hue2rgb = hue2rgb;
    ...
    CanvasRenderer.hslToRgb = hslToRgb;
})(CanvasRenderer = exports.CanvasRenderer || (exports.CanvasRenderer = {}));
exports.CanvasRenderer = CanvasRenderer;
var Renderer = (function () {
    function Renderer() {
        this.ctx = document.createElement("canvas").getContext("2d");
    }
    Renderer.prototype.draw = function (src_cnv, entries) {
        var ctx = this.ctx;
        ...
        entries.forEach(function (_a) {
            var name = _a.name, id = _a.id, rect = _a.rect;
            var _b = rect[0], left = _b[0], top = _b[1], _c = rect[1], right = _c[0], bottom = _c[1];

...
},{"./foreign":1,"Control.Monad.Eff":4,"Prelude":7}],3:[function(require,module,exports){
/* global exports */
"use strict";
...
},{"./foreign":3,"Prelude":7}],5:[function(require,module,exports){
// Generated by psc version 0.7.0.0
"use strict";
var Control_Monad_Eff_Console = require("Control.Monad.Eff.Console");
var main = Control_Monad_Eff_Console.log("Hello Pure!");
module.exports = {
    main: main
};

},{"Control.Monad.Eff.Console":2}],6:[function(require,module,exports){
/* global exports */
"use strict";
...
var showUnit = new Show(function (_56) {
    return "unit";
});
...
var showOrdering = new Show(function (_57) {
    ...
    throw new Error("Failed pattern match at /Users/yohsukeino/GitHub/PROJECT/duxca.lib.js/bower_components/purescript-prelude/src/Prelude.purs line 851, column 1 - line 856, column 1: " + [ _57.constructor.name ]);
});
var showNumber = new Show($foreign.showNumberImpl);
var showInt = new Show($foreign.showIntImpl);
var showChar = new Show($foreign.showCharImpl);
var showBoolean = new Show(function (_55) {
    if (_55) {
        return "true";
    };
    if (!_55) {
    ...
    throw new Error("Failed pattern match at /Users/yohsukeino/GitHub/PROJECT/duxca.lib.js/bower_components/purescript-prelude/src/Prelude.purs line 829, column 1 - line 833, column 1: " + [ _55.constructor.name ]);
});
...
var semiringUnit = new Semiring(function (_28) {
    return function (_29) {
        return unit;
    };
}, function (_30) {
...
var semigroupOrdering = new Semigroup(function (_27) {
    return function (y) {
        ...
        throw new Error("Failed pattern match at /Users/yohsukeino/GitHub/PROJECT/duxca.lib.js/bower_components/purescript-prelude/src/Prelude.purs line 413, column 1 - line 418, column 1: " + [ _27.constructor.name, y.constructor.name ]);
    };
});
...
var eqUnit = new Eq(function (_40) {
    return function (_41) {
        return true;
    };
});
...
var eqOrdering = new Eq(function (_42) {
    return function (_43) {
...
var ordOrdering = new Ord(function () {
    ...
    return function (_47) {
        ...
        if (_46 instanceof EQ && _47 instanceof LT) {
            return GT.value;
        };
        if (_46 instanceof EQ && _47 instanceof GT) {
            return LT.value;
        };
        if (_46 instanceof GT) {
            return GT.value;
        };
        throw new Error("Failed pattern match at /Users/yohsukeino/GitHub/PROJECT/duxca.lib.js/bower_components/purescript-prelude/src/Prelude.purs line 668, column 1 - line 677, column 1: " + [ _46.constructor.name, _47.constructor.name ]);
    };
});
    ...
    return new Ord(function () {
        ...
        return function (ys) {
            return $dollar(compare(ordInt)(0))($foreign.ordArrayImpl(function (x) {
                return function (y) {
                    var _460 = compare(__dict_Ord_16)(x)(y);
                    if (_460 instanceof EQ) {
                        return 0;
                    };
                    if (_460 instanceof LT) {
                        return 1;
                    };
                    if (_460 instanceof GT) {
                        return negate(ringInt)(1);
                    };
                    throw new Error("Failed pattern match at /Users/yohsukeino/GitHub/PROJECT/duxca.lib.js/bower_components/purescript-prelude/src/Prelude.purs line 660, column 1 - line 666, column 1: " + [ _460.constructor.name ]);
                };
            })(xs)(ys));
        };
    });
...
var $less = function (__dict_Ord_17) {
    return function (a1) {
        return function (a2) {
            var _461 = compare(__dict_Ord_17)(a1)(a2);
            if (_461 instanceof LT) {
                return true;
            };
            return false;
        };
...
var $less$eq = function (__dict_Ord_18) {
    return function (a1) {
        return function (a2) {
            var _462 = compare(__dict_Ord_18)(a1)(a2);
            if (_462 instanceof GT) {
                return false;
            };
            return true;
        };
...
var $greater = function (__dict_Ord_19) {
    return function (a1) {
        return function (a2) {
            var _463 = compare(__dict_Ord_19)(a1)(a2);
            if (_463 instanceof GT) {
                return true;
            };
            return false;
        };
...
var $greater$eq = function (__dict_Ord_20) {
    return function (a1) {
        return function (a2) {
            var _464 = compare(__dict_Ord_20)(a1)(a2);
            if (_464 instanceof LT) {
                return false;
            };
            return true;
        };
...
var boundedFn = function (__dict_Bounded_21) {
    return new Bounded(function (_49) {
...
var liftM1 = function (__dict_Monad_23) {
    return function (f) {
        return function (a) {
            return bind(__dict_Monad_23["__superclass_Prelude.Bind_1"]())(a)(function (_9) {
                return $$return(__dict_Monad_23["__superclass_Prelude.Applicative_0"]())(f(_9));
            });
        };
    };
};
...
},{"./foreign":6}],8:[function(require,module,exports){
...
},{"../ts/CanvasRender":9,"../ts/Chord":10,"../ts/FDTD":11,"../ts/FPS":12,"../ts/Metronome":13,"../ts/Newton":14,"../ts/OSC":15,"../ts/QRCode":16,"../ts/RecordBuffer":18,"../ts/Sandbox1":19,"../ts/Sandbox2":20,"../ts/Sandbox3":21,"../ts/Sandbox4":22,"../ts/Sandbox5":23,"../ts/Sandbox6":24,"../ts/Sandbox7":25,"../ts/Sandbox8":26,"../ts/Sandbox9":27,"../ts/Signal":28,"../ts/Statictics":29,"../ts/Wave":30,"Main":5}],9:[function(require,module,exports){
...
},{"./Signal":28,"./Statictics":29}],10:[function(require,module,exports){
...
},{"./CanvasRender":9}],12:[function(require,module,exports){
var FPS = (function () {
    function FPS(period) {
        this.period = period;
...
},{"./CanvasRender":9,"./RecordBuffer":18,"./Signal":28}],16:[function(require,module,exports){
...
},{"./CanvasRender":9,"./Chord":10,"./FPS":12,"./Metronome":13,"./OSC":15,"./RecordBuffer":18,"./Signal":28,"./Statictics":29,"./Wave":30}],20:[function(require,module,exports){
/// <reference path="../../typings/webrtc/MediaStream.d.ts"/>
/// <reference path="../../tsd/console.snapshot/console.snapshot.d.ts"/>
/// <reference path="../../tsd/MediaStreamAudioSourceNode/MediaStreamAudioSourceNode.d.ts"/>
var CanvasRender = require("./CanvasRender");
...
},{"./CanvasRender":9,"./Chord":10,"./OSC":15,"./RecordBuffer":18,"./Signal":28,"./Statictics":29}],21:[function(require,module,exports){
/// <reference path="../../typings/webrtc/MediaStream.d.ts"/>
/// <reference path="../../tsd/console.snapshot/console.snapshot.d.ts"/>
/// <reference path="../../tsd/MediaStreamAudioSourceNode/MediaStreamAudioSourceNode.d.ts"/>
var CanvasRender = require("./CanvasRender");
...
},{"./CanvasRender":9,"./Chord":10,"./OSC":15,"./RecordBuffer":18,"./Signal":28,"./Statictics":29}],22:[function(require,module,exports){
/// <reference path="../../typings/webrtc/MediaStream.d.ts"/>
/// <reference path="../../tsd/console.snapshot/console.snapshot.d.ts"/>
/// <reference path="../../tsd/MediaStreamAudioSourceNode/MediaStreamAudioSourceNode.d.ts"/>
var CanvasRender = require("./CanvasRender");
...
},{"./CanvasRender":9,"./Chord":10,"./OSC":15,"./RecordBuffer":18,"./Signal":28,"./Statictics":29}],23:[function(require,module,exports){
/// <reference path="../../typings/webrtc/MediaStream.d.ts"/>
/// <reference path="../../tsd/console.snapshot/console.snapshot.d.ts"/>
/// <reference path="../../tsd/MediaStreamAudioSourceNode/MediaStreamAudioSourceNode.d.ts"/>
var CanvasRender = require("./CanvasRender");
...
},{"./CanvasRender":9,"./Chord":10,"./OSC":15,"./RecordBuffer":18,"./Signal":28,"./Statictics":29}],24:[function(require,module,exports){
/// <reference path="../../typings/webrtc/MediaStream.d.ts"/>
/// <reference path="../../tsd/console.snapshot/console.snapshot.d.ts"/>
/// <reference path="../../tsd/MediaStreamAudioSourceNode/MediaStreamAudioSourceNode.d.ts"/>
var CanvasRender = require("./CanvasRender");
...
},{"./CanvasRender":9,"./Chord":10,"./Newton":14,"./OSC":15,"./RecordBuffer":18,"./Signal":28,"./Statictics":29}],25:[function(require,module,exports){
/// <reference path="../../typings/webrtc/MediaStream.d.ts"/>
/// <reference path="../../tsd/console.snapshot/console.snapshot.d.ts"/>
/// <reference path="../../tsd/MediaStreamAudioSourceNode/MediaStreamAudioSourceNode.d.ts"/>
var CanvasRender = require("./CanvasRender");
...
},{"./CanvasRender":9,"./Chord":10,"./Newton":14,"./OSC":15,"./RecordBuffer":18,"./Signal":28,"./Statictics":29}],26:[function(require,module,exports){
/// <reference path="../../typings/webrtc/MediaStream.d.ts"/>
/// <reference path="../../tsd/console.snapshot/console.snapshot.d.ts"/>
/// <reference path="../../tsd/MediaStreamAudioSourceNode/MediaStreamAudioSourceNode.d.ts"/>
var CanvasRender = require("./CanvasRender");
...
},{"./CanvasRender":9,"./FDTD":11,"./QRcode":17}],27:[function(require,module,exports){
module.exports = {};
...
},{"./Statictics":29}],29:[function(require,module,exports){
var Statictics;
(function (Statictics) {

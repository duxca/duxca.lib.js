...
var showOrdering = new Show(function (_37) {
    ...
    throw new Error("Failed pattern match at /Users/yohsukeino/GitHub/PROJECT/duxca.lib.js/bower_components/purescript-prelude/src/Prelude.purs line 851, column 1 - line 856, column 1: " + [ _37.constructor.name ]);
});
...
var showBoolean = new Show(function (_35) {
    ...
    throw new Error("Failed pattern match at /Users/yohsukeino/GitHub/PROJECT/duxca.lib.js/bower_components/purescript-prelude/src/Prelude.purs line 829, column 1 - line 833, column 1: " + [ _35.constructor.name ]);
});
...
var semigroupOrdering = new Semigroup(function (_7) {
    return function (y) {
        ...
        throw new Error("Failed pattern match at /Users/yohsukeino/GitHub/PROJECT/duxca.lib.js/bower_components/purescript-prelude/src/Prelude.purs line 413, column 1 - line 418, column 1: " + [ _7.constructor.name, y.constructor.name ]);
    };
});
...
var ordOrdering = new Ord(function () {
    ...
    return function (_27) {
        ...
        throw new Error("Failed pattern match at /Users/yohsukeino/GitHub/PROJECT/duxca.lib.js/bower_components/purescript-prelude/src/Prelude.purs line 668, column 1 - line 677, column 1: " + [ _26.constructor.name, _27.constructor.name ]);
    };
});
        ...
        return function (ys) {
            return $dollar(compare(ordInt)(0))($foreign.ordArrayImpl(function (x) {
                return function (y) {
                    ...
                    throw new Error("Failed pattern match at /Users/yohsukeino/GitHub/PROJECT/duxca.lib.js/bower_components/purescript-prelude/src/Prelude.purs line 660, column 1 - line 666, column 1: " + [ _46.constructor.name ]);
                };
            })(xs)(ys));
        };
    });

 ...
 * ```
 */
function autoEventListener(that) {
    return function (remove_event) { return function (on, off) { return function (target) {
        var $ = {
...
exports.autoEventListener = autoEventListener;
/**
 * @deprecated
 */

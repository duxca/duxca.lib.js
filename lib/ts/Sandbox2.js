...
(function (Sandbox) {
    ...
    function testAutoDetect3(id) {
        ...
        var codeA = Signal_1.default.createBarkerCode(13);
                        ...
                        return chd.request("startRec", { member: member })
                            ...
                            data.forEach(function (_a, i) {
                                ...
                                data.forEach(function (_a, j) {
                                    ...
                                    console.log("__RES__", id1 + "-" + id2, Statictics_1.default.median(results[id1 + "-" + id2]) * 170);
                                });
                            });
        ...
        function setupChord() {
            var chd = new Chord_1.Chord({ host: "localhost", port: 9000 });
        ...
        function createPulse(code, length) {
            var chirp = Signal_1.default.createCodedChirp(code, length);
        ...
        function calcCorr(pulse, rawdata) {
            ...
            for (var i = 0; rawdata.length - (i + windowsize) >= resized_pulse.length; i += windowsize) {
                ...
                var corr = Signal_1.default.correlation(buffer, resized_pulse);
        ...
        function calc(myId) {
            ...
            Object.keys(pulseReady).forEach(function (id) {
                ...
                var _a = Statictics_1.default.findMax(stdsectionA), max_score = _a[0], max_offset = _a[1];
    ...
    function testAutoDetect2(id) {
        ...
        var actx = new AudioContext();
        var codeA = Signal_1.default.createBarkerCode(1);
        ...
        function calcStdscore(correlation) {
            ...
            var ave = Statictics_1.default.average(_correlation);
            var vari = Statictics_1.default.variance(_correlation);
            console.log("ave:", ave, "\n", "med:", Statictics_1.default.median(_correlation), "\n", "var:", vari, "\n");
            var stdscores = new Float32Array(_correlation.length);
            for (var i = 0; i < _correlation.length; i++) {
                stdscores[i] = 10 * (_correlation[i] - ave) / vari + 50;
            }
        ...
        function calc(myId) {
            ...
            Object.keys(pulseReady).forEach(function (id) {
                ...
                var _section = Signal_1.default.normalize(section, 128); // _** for draw
                ...
                for (var i = 0; i < _section.length; i += splitsize) {
                    ...
                    var _a = Statictics_1.default.findMax(part), max_score = _a[0], offset = _a[1];
                ...
                var ave = Statictics_1.default.average(offsets);
                var med = Statictics_1.default.median(offsets);
                var mode = Statictics_1.default.mode(offsets);
                var _b = Statictics_1.default.findMax(sumarr), max_score = _b[0], offset = _b[1];
                console.log("min", Statictics_1.default.findMin(offsets)[0], "\n", "max", Statictics_1.default.findMax(offsets)[0], "\n", "ave", ave, "red", "\n", "med", med, "green", "\n", "mode", mode, "blue", "\n", "sum", offset, "yellow", "\n", "stdev", Statictics_1.default.stdev(offsets));

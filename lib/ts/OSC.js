...
var OSC = (function () {
    ...
    OSC.prototype.createBarkerCodedChirp = function (barkerCodeN, powN, powL) {
        ...
        var actx = this.actx;
        var osc = this;
        var code = Signal_1.default.createBarkerCode(barkerCodeN);
        var chirp = Signal_1.default.createCodedChirp(code, powN);
    ...
    OSC.prototype.resampling = function (sig, pow, sampleRate) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var recbuf = new RecordBuffer_1.default(_this.actx.sampleRate, processor.bufferSize, processor.channelCount);
    ...
    OSC.prototype.inpulseResponce = function (TEST_INPUT_MYSELF) {
        ...
        new Promise(function (resolbe, reject) { return navigator.getUserMedia({ video: false, audio: true }, resolbe, reject); })
            ...
            function next() {
                var rawdata = recbuf.merge();
                var corr = Signal_1.default.overwarpCorr(down, rawdata);

...
var Point = Newton_1.default.Point;
var SDM = Newton_1.default.SDM;
var Sandbox;
(function (Sandbox) {
    function testDetect8(rootNodeId) {
        ...
        osc.createBarkerCodedChirp(13, 8).then(function (pulse) {
            ...
            chord.on("distribute", function (token, cb) {
                ...
                Object.keys(pulseTimes).forEach(function (id1) {
                    ...
                    Object.keys(pulseTime).forEach(function (id2) {
                        ...
                        console.log("__RES__", id1, id2, "delayTime", delayTime, "distance", delayTime / 2 * 340, "ave", Statictics_1.default.average(delayTimesLog[id1][id2]), "mode", Statictics_1.default.mode(delayTimesLog[id1][id2]), "med", Statictics_1.default.median(delayTimesLog[id1][id2]), "stdev", Statictics_1.default.stdev(delayTimesLog[id1][id2]));
                    });
                });
            ...
            chord.on("play", function (token, cb) {
                ...
                var delay = Statictics_1.default.median(delayTimesLog[id1][id2]);
        ...
        function relpos(relDelayTimes) {
            ...
            var pseudoPts = names.map(function (id1, i) { return new Point(Math.random() * 10, Math.random() * 10); });
